<nav class="bg-white" x-data="{ open: false }">
  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div class="relative flex h-16 items-center justify-between">
      <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        <!-- Mobile menu button-->
        <button type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false" aria-controls="mobile-menu" @click="open = !open" x-bind:aria-expanded="open.toString()">
  ...
  <div class="sm:hidden" id="mobile-menu" x-show="open">
    <div class="space-y-1 px-2 pt-2 pb-3">
      ...
      @if (has_nav_menu('primary_navigation'))
        {!! wp_nav_menu($primarySmallNavigation) !!}
      @endif
    </div>
  </div>
</nav>
