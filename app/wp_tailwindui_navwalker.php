 ...
 *
 * @package WP-TailwindUI-Navwalker
 *
 * @wordpress-plugin
 * Plugin Name: WP TailwindUI Navwalker
...
if ( ! class_exists( 'WP_TailwindUI_Navwalker' ) ) :
    /**
     * WP_Bootstrap_Navwalker class.
     */
    class WP_TailwindUI_Navwalker extends Walker_Nav_Menu {
        ...
        public function start_lvl( &$output, $depth = 0, $args = null ) {
            ...
            $class_names = $class_names ? ' class="' . esc_attr( $class_names ) . '"' : 'text-gray-500 group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-';
